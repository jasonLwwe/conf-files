...
variable_set('node_export_reset_author_poll', 0);
variable_set('node_export_reset_book_mlid_poll', 0);
variable_set('node_export_reset_changed_poll', 0);
variable_set('node_export_reset_created_poll', 0);
variable_set('node_export_reset_last_comment_timestamp_poll', 0);
variable_set('node_export_reset_menu_poll', 0);
variable_set('node_export_reset_path_poll', 0);
variable_set('node_export_reset_promote_poll', 0);
variable_set('node_export_reset_revision_timestamp_poll', 0);
variable_set('node_export_reset_status_poll', 0);
variable_set('node_export_reset_sticky_poll', 0);
